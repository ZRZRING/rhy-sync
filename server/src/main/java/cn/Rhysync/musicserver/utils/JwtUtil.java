...
public class JwtUtil {
    ...
    //设置秘钥明文
    private static final String JWT_KEY = "kgc369-2024-very-very-secret-key-please-change"; // 建议32位以上
    ...
    private static JwtBuilder getJwtBuilder(String subject, Long ttlMillis, String uuid) {
        ...
        return Jwts.builder()
                ...
                .signWith(secretKey, signatureAlgorithm) //使用HS256对称加密算法签名, 新写法
